      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-12 justify-items-start md:justify-items-center">
        ...
        <div className="flex flex-col justify-start order-2 md:order-3">
          ...
          <div className="flex gap-4 text-[30px]">
            <a
              href="https://wa.me/087887990222"
              target="_blank"
              className="hover:text-[#F05A29]"
            >
              <FaWhatsapp />
            </a>
            <a
              href="https://www.instagram.com/awbalidigital?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              target="_blank"
              className="hover:text-[#F05A29]"
            >
              <FaInstagram />
