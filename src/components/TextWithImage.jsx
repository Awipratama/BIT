      ...
      <div classname="flex flex-col md:flex-row justify-center items-center gap-18">
        ...
        <div className="hero-text w-full">
          ...
          <p classname="text-[18px] md:text-[20px] text-[#898895]">
            ...
            vitae mauris id eros interdum sagittis a ut eros. Nunc scelerisque
            imperdiet ex pretium consequat. Vivamus viverra fermentum aliquam.
            Aliquam tristique, orci vel vulputate vehicula, erat libero
            convallis quam, vitae laoreet dolor nisi nec elit.
          </p>
        </div>
