...
export default function SolutionSection() {
  return (
    <section id="solution" className="flex flex-col px-4 md:px-32 py-20">
      ...
      <div className="grid grid-rows-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        <div className="card transition duration-300 ease-out bg-[#003C97] hover:bg-linear-to-t hover:from-[#8A3418] hover:to-[#F05A29] text-white px-8 md:px-6 py-16 text-left">
